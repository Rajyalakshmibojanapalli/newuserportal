...
const JaimaxSplash = () => {
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center">
      ...
      <div className={`absolute inset-0 flex items-center justify-center z-20 transition-all duration-800 ease-out ${
        phase === 'logoBlur' || phase === 'settled' ? 'opacity-100' : 'opacity-0'
      }`}>
        <div className="text-center">
          <h1 className={`text-9xl font-black text-white transition-all duration-800 ease-out ${
            phase === 'logoBlur' ? 'blur-lg scale-95' : phase === 'settled' ? 'blur-none scale-100' : 'blur-xl scale-90'
          }`}
          style={{
          ...
          {/* Subtitle appears after logo settles */}
