...
//   const Icons = {
//     bitcoin: () => (
//       <div className="w-10 h-10 rounded-full flex items-center justify-center shadow-lg border-2" style={{
...
//                 }}>
//                   <OrbitDot delay={i * 0.3} size="large" />
//                 </div>
//               ))}
//             </div>
...
//           {/* Outer orbit - 8 icons */}
//           {[Icons.bitcoin, Icons.ethereum, Icons.stocks, Icons.dollar, Icons.profits, Icons.users, Icons.rupees, Icons.usd].map((IconComponent, index) => {
...
//                   <div className="absolute -inset-2 rounded-full blur-sm" style={{
...
//           {/* Middle orbit - 5 icons */}
//           {[Icons.portfolio, Icons.wallet, Icons.ethereum, Icons.profits, Icons.shares].map((IconComponent, index) => {
...
//           {/* Inner orbit - 6 icons */}
//           {[Icons.growth, Icons.investment, Icons.bonds, Icons.shares, Icons.trending, Icons.analytics].map((IconComponent, index) => {
