...
function PhaseCarousel() {
  ...
  const navigationPrevRef = useRef(null); // Create a ref for the previous button
  const navigationNextRef = useRef(null); // Create a ref for the next button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            {/* <div ref={navigationPrevRef} className="swiper-button-prev text-white cursor-pointer absolute top-1/2 -translate-y-1/2 left-2 z-10 focus:outline-none"></div>
